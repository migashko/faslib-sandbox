...
struct ad_field_list: ::fas::serialization::deser::ad_primary_list< ::fas::json::parse::_comma_, ::fas::json::parse::_object_field_, ::fas::json::parse::_right_brace_ > {};
...
struct aspect:
  ::fas::aspect< type_list_n<
    ...
    //advice< _targets_, ::fas::serialization::deser::ad_targets<_target_list_> >,
